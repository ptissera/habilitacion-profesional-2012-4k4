...
<html>
	...
	<body>
		<a href="#edit-permisoAcceso" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
		<div class="nav" role="navigation">
			<ul>
				<li><g:link class="create" action="create"><g:message code="default.new.label" args="[entityName]" /></g:link></li>
			</ul>
		</div>
		<div id="edit-permisoAcceso" class="content scaffold-edit" role="main">
			...
			<g:form method="post"  enctype="multipart/form-data">
				...
				<g:hiddenField name="version" value="${permisoAccesoInstance?.version}" />
				<fieldset class="form">
