	...
	<body>
		...
		<div id="show-role" class="content scaffold-show" role="main">
			...
			<ol class="property-list role">
				...
				<g:if test="${roleInstance?.people}">
				<li class="fieldcontain">
					<span id="people-label" class="property-label"><g:message code="role.people.label" default="People" /></span>
					
						<g:each in="${roleInstance.people}" var="p">
						<span class="property-value" aria-labelledby="people-label"><g:link controller="user" action="show" id="${p.id}">${p?.encodeAsHTML()}</g:link></span>
						</g:each>
