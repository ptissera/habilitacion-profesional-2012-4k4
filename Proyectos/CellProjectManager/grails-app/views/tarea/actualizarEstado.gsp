...
<body>
  ...
  <g:form >
    <h1>Actualizar Progreso de Tarea</h1>
    ...
    <ol class="property-list tarea">
      ...
      <g:if test="${tareaInstance?.tipoTarea}">
        ...
        <li class="fieldcontain">
          ...
          <span class="property-value" aria-labelledby="estado-label"><g:select id="estado" name="estado.id" from="${business.tarea.EstadoTarea.list()}" optionKey="id" required="" value="${tareaInstance?.estado?.id}" class="many-to-one"/></span>
      ...
      <fieldset class="buttons">
        ...
        <g:actionSubmit class="save" action="guardarEstado" value="Actualizar" />
      </fieldset>
    </g:form>
  </div>
</body>
