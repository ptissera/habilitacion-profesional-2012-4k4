...
<html>
  ...
  <body>
    ...
    <div id="show-reporte" class="content scaffold-show" role="main">
      <h1>Informe de Vencimientos de Documentos - Paso 1/2</h1>
      ...
      <g:form action="step2" >
        <ol class="property-list">
          <li class="fieldcontain">
            <span id="nombre-label" class="property-label">Tipos de Documentos:</span>
           <span class="property-value">
              <g:checkBoxList name="tipoDocumentacionesIds" from="${tipoDocumentacionesListInstance}" value="${tipoDocumentacionesListInstance}" optionKey="id"/>             
           </span>
          </li>
           <li class="fieldcontain">
