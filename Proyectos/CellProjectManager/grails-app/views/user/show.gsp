			...
			<ol class="property-list user">
				...
				<li class="fieldcontain">
					<span id="authorities-label" class="property-label"><g:message code="user.authorities.label" default="Authorities" /></span>
						...
						<span class="property-value" aria-labelledby="authorities-label"><g:link controller="role" action="show" id="${userInstance?.authorities?.id}">${userInstance?.authorities?.encodeAsHTML()}</g:link></span>
