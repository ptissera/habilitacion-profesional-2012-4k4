	...
	<body>
		...
		<div id="show-unidadMedida" class="content scaffold-show" role="main">
			...
			<ol class="property-list unidadMedida">
				...
				<g:if test="${unidadMedidaInstance?.nombre}">
				<li class="fieldcontain">
					<span id="nombre-label" class="property-label"><g:message code="unidadMedida.nombre.label" default="Nombre" /></span>
					
						<span class="property-value" aria-labelledby="nombre-label"><g:fieldValue bean="${unidadMedidaInstance}" field="nombre"/></span>
					
				</li>
				</g:if>
			
				<g:if test="${unidadMedidaInstance?.materiales}">
				<li class="fieldcontain">
					<span id="materiales-label" class="property-label"><g:message code="unidadMedida.materiales.label" default="Materiales" /></span>
					
						<g:each in="${unidadMedidaInstance.materiales}" var="m">
